...
ds_map_add(global.plant_database, "stardust",   
		...
		plant_sprite: [spr_plant_stardust, spr_plant_stardust, spr_plant_stardust, spr_plant_stardust, spr_plant_stardust],
        fruit_sprite: -1,
		fruit_card: -1,
		material_card: "Radiant Root",
		fruit_card_n: 0,
		fruit_x: 0,
		fruit_y: 0,
		fruit_wiggle: 0,
