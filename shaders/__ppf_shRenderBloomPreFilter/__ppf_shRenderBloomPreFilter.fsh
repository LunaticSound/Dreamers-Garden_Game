 ...
 * GameMaker Integration and Improvements by Mozart Junior, 2023-2025.*/

#define ANTI_FLICKER // comment this if not
...
void main() {
	gl_FragColor = vec4(Threshold(
	#ifdef ANTI_FLICKER
		SampleBox4Antiflicker(gm_BaseTexture, v_vTexcoord, 0.5).rgb
	#else
